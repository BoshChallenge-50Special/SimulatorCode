...
class StatModel(object):
    def load(self, fn):
        self.model.load(fn)  # Known bug: https://github.com/opencv/opencv/issues/4969 self.model = cv2.ml.SVM_load(filename)
...
if __name__ == '__main__':
    model = training()
    path = '/home/ebllaei/dataset_bosch/1/img_446.png'
    watch = cv2.imread(path)
    sign = model.predict(watch)
    print(sign)
